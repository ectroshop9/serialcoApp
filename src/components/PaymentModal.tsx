...
export default function PaymentModal({ selectedPlan }: Props) {
  ...
  const paymentLinks: Record<string, string> = {
    'ذهبية': 'http://pay.chargily.com/payment-links/01ky4wqryf3ykyw2agv6c3kxbn',
    'فضية': 'http://pay.chargily.com/payment-links/01ky4wney9wgvc04v8e4przecp',
  };
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
        ...
        <a
          href={`https://wa.me/213673310066?text=مرحباً، أريد الاشتراك في الباقة ${selectedPlan} والدفع عبر بريدي موب`}
          target="_blank"
          style={{
            display: 'flex', alignItems: 'center', gap: 14,
            padding: '16px 18px', borderRadius: 14,

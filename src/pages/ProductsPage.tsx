...
import { Search, Download, ShoppingCart, ArrowRight, AlertCircle, Loader2, X } from 'lucide-react';
...
export default function ProductsPage() {
  ...
  // جلب البيانات مع تجنب مشاكل الـ Race Conditions
  useEffect(() => {
    let isMounted = true;
    setLoading(true);
    setError(null);
      ...
      <div className="anim-fade-up">
        <div className="field" style={{ maxWidth: 400, position: 'relative' }}>
          ...
          <input
            ...
            style={{ paddingLeft: q ? 36 : undefined }}
          />
          {q && (
            <button
              type="button"
      ...
      {loading ? (
        ...
        <div className="card" style={{ padding: 60, textAlign: 'center' }}>
          ...
          <p style={{ color: 'var(--text-muted)' }}>
            {q ? `لم يتم العثور على نتائج تطابق "${q}"` : 'لم يتم العثور على منتجات في هذا التصنيف'}
          </p>
        </div>
      ) : (
        /* شبكة المنتجات */
          ...
          {filteredProducts.map(product => (
            <div
              ...
              style={{
                ...
                justifyContent: 'space-between', // تم التعديل هنا من justify إلى justifyContent
              }}
            >
              <div>
                <div
                ...
                <div style={{ fontSize: 18, fontWeight: 900, color: 'var(--primary)', marginBottom: 16 }}>
                  {product.price} ر.س
                </div>
              </div>
